      ...
      <section class="pt-5" id="content">
        <div class="container-fluid px-md-4 pb-5">
          ...
          <div align="center" class="mb-5">
              <h1 class="mb-0 font-anton">
                VARANDA GOURMET<br>GRUTA SÃO SEBASTIÃO
              </h1>
          ...
          <div uk-grid uk-lightbox="animation: fade">
            ...
            <div class="d-md-flex">
              ...
              <a href="projects/varanda-gourmet-gruta-sao-sebastiao/1.JPG" class="w-100 d-block mb-2 mb-md-0">
                  <img src="projects/varanda-gourmet-gruta-sao-sebastiao/1.JPG" class="img-gallery h-md-450">
              </a>
              <a href="projects/varanda-gourmet-gruta-sao-sebastiao/2.JPG" class="w-100 d-block mb-2 mb-md-0">
                  <img src="projects/varanda-gourmet-gruta-sao-sebastiao/2.JPG" class="img-gallery h-md-450">
              </a>

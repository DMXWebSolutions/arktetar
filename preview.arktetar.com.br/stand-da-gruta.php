      ...
      <section class="pt-5" id="content">
        <div class="container-fluid px-md-4 pb-5">
          ...
          <div align="center" class="mb-5">
              <h1 class="mb-0 font-anton">STAND DA GRUTA</h1>
          ...
          <div uk-grid uk-lightbox="animation: fade">
            ...
            <div class="d-md-flex">
              ...
              <a href="projects/stand-da-gruta/1.jpg" class="w-100 d-block mb-2 mb-md-0">
                  <img src="projects/stand-da-gruta/1.jpg" class="img-gallery h-md-450">
              </a>
              <a href="projects/stand-da-gruta/2.jpg" class="w-100 d-block mb-2 mb-md-0">
                  <img src="projects/stand-da-gruta/2.jpg" class="img-gallery h-md-450">
              </a>
            ...
            <div class="d-md-flex my-0 py-0">
              ...
              <a href="projects/stand-da-gruta/3.jpg" class="w-100 d-block mb-2 mb-md-0">
                  <img src="projects/stand-da-gruta/3.jpg" class="img-gallery h-md-450">
              </a>
              <a href="projects/stand-da-gruta/4.jpg" class="w-100 d-block mb-2 mb-md-0">
                  <img src="projects/stand-da-gruta/4.jpg" class="img-gallery h-md-450">
              </a>
